exports = module.exports = (function() {
  var config = {
    scriptPath: '/embedjs/5176e89e68f9daff42000013/video/56df733794c05f768f000031.js',
    playerBaseUrl: 'http://player.cnevids.com',
    embedPath: '/embed/56df733794c05f768f000031/5176e89e68f9daff42000013'
  };
  ...
  var embedLoader = {
    ...
    findMyself: function() {
      ...
      for (var i = 0, len = scripts.length; i < len; ++i) {
        ...
        if (currentScriptClasses.indexOf(' cne-dirty ') >= 0) {
          me = currentScript;
          break;
        }
      }
